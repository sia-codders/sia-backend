...
class UsuarioSelectController {
    ...
    public function __construct($json) {
        ...
        $this->master_select= new MasterCrudSelect();
    ...
    private function consultar_usuario_todos() {
        ...
        $this->respuesta = $this->master_select->consultar_base($sentencia);
    }
    ...
    private function consultar_usuario_por_id() {
     ...
     public function generar_respuesta() {         
        return  $this->master_select->genera_respuesta($this->respuesta);       
    }
}
